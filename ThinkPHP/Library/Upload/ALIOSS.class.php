...
namespace Upload;
//ACCESS_ID  
define('OSS_ACCESS_ID', '77AXFOMyoZfk7Uxr');
//ACCESS_KEY 
define('OSS_ACCESS_KEY', 'cbs1CkVvUnsqWoZfoFQLAY6aY1eC0F');
...
class ALIOSS{
	 ...
	 * OSS服务地址
	 */
	//const DEFAULT_OSS_HOST = 'oss-cn-shenzhen.aliyuncs.com';//Bucket地域
	...
	public function process_response($curl_handle = null, $response = null)
	{
		...
		if (is_resource($this->curl_handle))
		{
			...
			if ($curl_handle && $response)
			{
				...
				$r =  new ResponseCore();
				$r->res($this->response_headers, $this->response_body, $this->response_code, $this->curl_handle);
				return $r;
			}
		}
...
class ResponseCore
{
	 ...
	 */
	public function res($header, $body, $status = null)
	{
		$this->header = $header;
		$this->body = $body;
		$this->status = $status;
