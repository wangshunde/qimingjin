...
$input->SetNotify_url("http://www.hkmynet.com/hkmy/Wxpay2/notify.php");
		...
		WeixinJSBridge.invoke(
			...
			function(res){
                ...
                if (res.err_msg == "get_brand_wcpay_request:ok") {
                	//支付成功返回跳转到订单详情页面
                    window.location.href="http://www.hkmynet.com/hkmy/index.php/Mnhuiyuanok/index1/dingdanhao/<?php echo $tem_pp_dingdanhao?>/huiyuanprice/<?php echo $tem_pp_num?>";
                }else{ 
				    // message: "已取消微信支付!"
                    window.location.href="http://www.hkmynet.com/hkmy/index.php/Mnhuiyuanfalse/index";
				}
			}
		);
	}
